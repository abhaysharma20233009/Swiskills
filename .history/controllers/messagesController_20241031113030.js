...
const Request = require('../models/Request'); // Ensure you import the Request model
...
exports.createMessage = catchAsync(async (req, res, next) => {
    ...
    const message = await chatMessage.create({
        ...
        recipient: recipientId,       // Use recipientId from the body
        content: content,     
        status:req.body.status,     // Array of strings
        timestamp: Date.now(),        // Optional: add a timestamp if necessary
    });
