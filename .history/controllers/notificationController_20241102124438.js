...
exports.markAsRead = catchAsync(async (req, res, next) => {
    ...
    const notification = await Notification.findOne({ notificationId, recipient:recipientId });
...
exports.deleteNotification = catchAsync(async (req, res, next) => {
    ...
    const notification = await Notification.findOneAndDelete({ notificationId, recipient:recipientId });
