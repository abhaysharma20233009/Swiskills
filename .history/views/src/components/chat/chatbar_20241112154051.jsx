...
const Chatlist = ({ onSelectChat }) => {
  ...
  return (
    <div className="border border-zinc-200 p-2 h-screen w-full">
      ...
      {/* Chat List */}
      <div className="h-5/6 md:h-5/6 overflow-y-scroll overflow-x-hidden scrollbar-thin scrollbar-thumb-slate-100 scrollbar-track-gray-600 space-y-3 p-2">
