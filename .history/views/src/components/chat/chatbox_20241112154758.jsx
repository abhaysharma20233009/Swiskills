...
// State to store the last seen timestamp
  ...
  return (
    <div className="flex flex-col w-full bg-transparent p-4 rounded-lg shadow-lg h-full md:h-screen border border-zinc-200">
      {/* Error Message Notification */}
      {errorMessage && (
        <div className="bg-gray-300 text-white text-center py-2 rounded mb-2 transition-opacity duration-500">
          {errorMessage}
        </div>
      )}
      ...
      <div className="flex items-center mb-4 space-x-2">
        <img src={chatUser.profilePicture} alt="" className="rounded-full h-10 w-10 md:h-12 md:w-12" />
        <div>
      ...
      {/* Messages List */}
      <div ref={messagesContainerRef} className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-100 scrollbar-track-gray-600  mb-4 p-2 border rounded-md bg-transparent">
            ...
            <div>
              ...
              {message.file && (
                message.type.startsWith('image/')
                  ? <img src={message.file} alt="Chat media" className="max-w-96 h-auto rounded-lg" />
