...
function Sidebar() {
  ...
  return (
    <div>
      ...
      <div className="p-4">
        <AiOutlineMenu className="text-white text-3xl cursor-pointer" onClick={toggleSidebar} />
      </div>

      {/* Sidebar */}
      <div className={`flex flex-col h-screen p-4 bg-zinc-800 text-gray-200 w-full ${isSidebarOpen ? 'block' : 'hidden'}`}>
