  ...
  return (
    <div className="max-w-4xl mx-auto p-6 font-sans bg-zinc-800">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-100">username:{username}</p>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-6 rounded-lg shadow-lg w-96">
            ...
            <SendRequestForm
              ...
              reviewReceiverUsername={username} 
            />
          </div>
        </div>
      )}
...
{showReviewModal && (
  <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
    <div className="bg-white p-6 rounded-lg shadow-lg w-96">
      ...
      <SendReview onClose={() => setShowReviewModal(false)} reviewReceiverUsername={username} userSkills={skills} />
    </div>
  </div>
)}
