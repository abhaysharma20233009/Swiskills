    ...
    <div className="max-w-4xl mx-auto p-6 font-sans bg-zinc-800">
      ...
      <section className="mb-8">
        ...
        {experience.map((exp, index) => (
          <div key={index}>
            <h3 className="text-lg text-gray-200 font-semibold">{exp.title}</h3>
      ...
      <section className="mb-8">
        ...
        {education.map((edu, index) => (
          <div key={index}>
            <h3 className="text-lg text-gray-200 font-semibold">{edu.degree}</h3>
            <p className="text-gray-200">{edu.university}</p>
            <p className="text-gray-200">{edu.graduation}</p>
          </div>
        ))}
      </section>
