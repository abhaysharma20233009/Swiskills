          ...
          <div className="flex items-center">
            ...
            {connectionStatus === 'pending' || connectionStatus === 'rejected' ? (
              <button
                ...
                className="bg-blue-500 text-white py-1 px-2 rounded-md flex items-center ml-3"
              >
              ...
              <button
                ...
                className="bg-green-500 text-white py-1 px-2 rounded-md flex items-center ml-3"
              >
