...
function SendRequestForm({ onClose, onRequestSuccess, reviewReceiverUsername }) {
  const [username] = useState(reviewReceiverUsername || ''); // Set the username directly from the prop
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      {/* Username input is removed as it is now set from the prop */}
