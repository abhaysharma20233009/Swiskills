...
function SendReview({ onClose, reviewReceiverUsername, userSkills }) {
  ...
  const handleSkillSelect = (skill) => {
    ...
    setFilteredSkills([]); // Clear suggestions once a skill is selected
  };
  ...
  return (
    <div className="max-w-md mx-auto bg-gray-800 text-white rounded-lg p-6 shadow-md">
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          <label htmlFor="reviewReceiver" className="block text-sm font-medium mb-2">
        ...
        <div className="mb-4 relative">
          ...
          {filteredSkills.length > 0 && (
            <ul className="absolute bg-gray-700 text-white w-full mt-1 rounded-md shadow-lg z-10">
