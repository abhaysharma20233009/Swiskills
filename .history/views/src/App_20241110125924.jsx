...
import sendForm from './components/feature/sendRequests';
...
function App() {
  ...
  if (loading) return <div>Loading...</div>; // Show a loading message or spinner while loading
        ...
        <Routes>
          ...
          {isAuthenticated ? (
            <>
              ...
              <Route path="/sendRequests" element={<sendForm/>} />
