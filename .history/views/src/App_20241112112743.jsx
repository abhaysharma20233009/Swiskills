...
function MainRoutes() {
  ...
  // Determine if we should render the Layout
  const shouldShowLayout = !['/', '/signup', '/login'].includes(location.pathname);

  return (
    <>
      {shouldShowLayout && <Layout />} {/* Render Layout if path is not /, /signup, or /login */}
      <Routes>
